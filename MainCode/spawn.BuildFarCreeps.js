    ...
    run: function(spawn, thisRoom, energyIndex) {
        ...
        if (thisRoom.storage) {
            ...
            if (containers.length) {
                storeTarget = containers[0]
            }
        }

        if (!spawn.spawning && storeTarget && Memory.roomsUnderAttack.indexOf(thisRoom.name) == -1) {
            let controlledCreeps = Game.creeps;

            let Flag25 = false;
            let Flag50 = false;
            let greatNeed = false;
            if (thisRoom.storage && ((thisRoom.storage.store[RESOURCE_POWER] && thisRoom.storage.store[RESOURCE_POWER] >= 100) || thisRoom.storage.store[RESOURCE_ENERGY] < 100000)) {
                greatNeed = true;
            }
            ...
            if (Memory.warMode) {
                if (Memory.guardType) {
                    //Ranged Guard
                    if (spawn.room.energyCapacityAvailable >= 5600 && Game.flags['FuckGierMode']) {
                        //Fuck Gier config
                        rangerConfig = [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE, RANGED_ATTACK, MOVE, RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE,RANGED_ATTACK, MOVE, RANGED_ATTACK,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,MOVE]
                    } else if (thisRoom.energyCapacityAvailable >= 5100) {
            ...
            if (Game.flags[thisRoom.name + "FarMining"] && prioritizedRole == '') {
            	let muleCount = 1;
            	if (Game.flags[Game.flags[thisRoom.name + "FarMining"].pos.roomName + "2Mule"]) {
            		muleCount = 2;
            	}
                if (farMiners.length < 1 && blockedRole != 'farMiner') {
                    ...
                    roomTarget = Game.flags[thisRoom.name + "FarMining"].pos.roomName;
                    flagName = Game.flags[thisRoom.name + "FarMining"].name;
                    storageID = storeTarget.id;
                } else if (farClaimers.length < 1 && thisRoom.controller.level >= 4 && Memory.FarClaimerNeeded[Game.flags[thisRoom.name + "FarMining"].pos.roomName] && blockedRole != 'farClaimer') {
            ...
            if (Game.flags[thisRoom.name + "FarMining2"] && prioritizedRole == '') {
            	let muleCount = 1;
            	if (Game.flags[Game.flags[thisRoom.name + "FarMining2"].pos.roomName + "2Mule"]) {
            		muleCount = 2;
            	}
                if (farMiners2.length < 1 && blockedRole != 'farMiner') {
                    ...
                    flagName = Game.flags[thisRoom.name + "FarMining2"].name;
                    storageID = storeTarget.id;
                } else if (farClaimers2.length < 1 && thisRoom.controller.level >= 4 && Memory.FarClaimerNeeded[Game.flags[thisRoom.name + "FarMining2"].pos.roomName] && blockedRole != 'farClaimer') {
                    prioritizedRole = 'farClaimer';
                    roomTarget = Game.flags[thisRoom.name + "FarMining2"].pos.roomName;
                    flagName = Game.flags[thisRoom.name + "FarMining2"].name;
                }
            ...
            if (!Flag50 && Game.flags[thisRoom.name + "FarMining3"] && prioritizedRole == '') {
            	let muleCount = 1;
            	if (Game.flags[Game.flags[thisRoom.name + "FarMining3"].pos.roomName + "2Mule"]) {
            		muleCount = 2;
            	}
                if (farMiners3.length < 1 && blockedRole != 'farMiner') {
                    ...
                    flagName = Game.flags[thisRoom.name + "FarMining3"].name;
                    storageID = storeTarget.id;
                } else if (farClaimers3.length < 1 && thisRoom.controller.level >= 4 && Memory.FarClaimerNeeded[Game.flags[thisRoom.name + "FarMining3"].pos.roomName] && blockedRole != 'farClaimer') {
                    prioritizedRole = 'farClaimer';
                    roomTarget = Game.flags[thisRoom.name + "FarMining3"].pos.roomName;
                    flagName = Game.flags[thisRoom.name + "FarMining3"].name;
                }
            ...
            if (!Flag50 && Game.flags[thisRoom.name + "FarMining4"] && prioritizedRole == '') {
            	let muleCount = 1;
            	if (Game.flags[Game.flags[thisRoom.name + "FarMining4"].pos.roomName + "2Mule"]) {
            		muleCount = 2;
            	}
                if (farMiners4.length < 1 && blockedRole != 'farMiner') {
                    ...
                    flagName = Game.flags[thisRoom.name + "FarMining4"].name;
                    storageID = storeTarget.id;
                } else if (farClaimers4.length < 1 && thisRoom.controller.level >= 4 && Memory.FarClaimerNeeded[Game.flags[thisRoom.name + "FarMining4"].pos.roomName] && blockedRole != 'farClaimer') {
                    prioritizedRole = 'farClaimer';
                    roomTarget = Game.flags[thisRoom.name + "FarMining4"].pos.roomName;
                    flagName = Game.flags[thisRoom.name + "FarMining4"].name;
                }
            ...
            if (!Flag25 && Game.flags[thisRoom.name + "FarMining5"] && prioritizedRole == '') {
            	let muleCount = 1;
            	if (Game.flags[Game.flags[thisRoom.name + "FarMining5"].pos.roomName + "2Mule"]) {
            		muleCount = 2;
            	}
                if (farMiners5.length < 1 && blockedRole != 'farMiner') {
                    ...
                    flagName = Game.flags[thisRoom.name + "FarMining5"].name;
                    storageID = storeTarget.id;
                } else if (farClaimers5.length < 1 && thisRoom.controller.level >= 4 && Memory.FarClaimerNeeded[Game.flags[thisRoom.name + "FarMining5"].pos.roomName] && blockedRole != 'farClaimer') {
                    prioritizedRole = 'farClaimer';
                    roomTarget = Game.flags[thisRoom.name + "FarMining5"].pos.roomName;
                    flagName = Game.flags[thisRoom.name + "FarMining5"].name;
                }
            ...
            if (!Flag25 && Game.flags[thisRoom.name + "FarMining6"] && prioritizedRole == '') {
            	let muleCount = 1;
            	if (Game.flags[Game.flags[thisRoom.name + "FarMining6"].pos.roomName + "2Mule"]) {
            		muleCount = 2;
            	}
                if (farMiners6.length < 1 && blockedRole != 'farMiner') {
                    ...
                    flagName = Game.flags[thisRoom.name + "FarMining6"].name;
                    storageID = storeTarget.id;
                } else if (farClaimers6.length < 1 && thisRoom.controller.level >= 4 && Memory.FarClaimerNeeded[Game.flags[thisRoom.name + "FarMining6"].pos.roomName] && blockedRole != 'farClaimer') {
                    prioritizedRole = 'farClaimer';
                    roomTarget = Game.flags[thisRoom.name + "FarMining6"].pos.roomName;
                    flagName = Game.flags[thisRoom.name + "FarMining6"].name;
                }
            ...
            if (!Flag25 && Game.flags[thisRoom.name + "FarMining7"] && prioritizedRole == '') {
            	let muleCount = 1;
            	if (Game.flags[Game.flags[thisRoom.name + "FarMining7"].pos.roomName + "2Mule"]) {
            		muleCount = 2;
            	}
                if (farMiners7.length < 1 && blockedRole != 'farMiner') {
                    ...
                    flagName = Game.flags[thisRoom.name + "FarMining7"].name;
                    storageID = storeTarget.id;
                } else if (farClaimers7.length < 1 && thisRoom.controller.level >= 4 && Memory.FarClaimerNeeded[Game.flags[thisRoom.name + "FarMining7"].pos.roomName] && blockedRole != 'farClaimer') {
                    prioritizedRole = 'farClaimer';
                    roomTarget = Game.flags[thisRoom.name + "FarMining7"].pos.roomName;
                    flagName = Game.flags[thisRoom.name + "FarMining7"].name;
                }
            ...
            if (!Flag25 && Game.flags[thisRoom.name + "FarMining8"] && prioritizedRole == '') {
            	let muleCount = 1;
            	if (Game.flags[Game.flags[thisRoom.name + "FarMining8"].pos.roomName + "2Mule"]) {
            		muleCount = 2;
            	}
                if (farMiners8.length < 1 && blockedRole != 'farMiner') {
                    ...
                    flagName = Game.flags[thisRoom.name + "FarMining8"].name;
                    storageID = storeTarget.id;
                } else if (farClaimers8.length < 1 && thisRoom.controller.level >= 4 && Memory.FarClaimerNeeded[Game.flags[thisRoom.name + "FarMining8"].pos.roomName] && blockedRole != 'farClaimer') {
                    prioritizedRole = 'farClaimer';
                    roomTarget = Game.flags[thisRoom.name + "FarMining8"].pos.roomName;
                    flagName = Game.flags[thisRoom.name + "FarMining8"].name;
                }
            ...
            if (!Flag25 && Game.flags[thisRoom.name + "FarMining9"] && prioritizedRole == '') {
            	let muleCount = 1;
            	if (Game.flags[Game.flags[thisRoom.name + "FarMining9"].pos.roomName + "2Mule"]) {
            		muleCount = 2;
            	}
                if (farMiners9.length < 1 && blockedRole != 'farMiner') {
                    ...
                    flagName = Game.flags[thisRoom.name + "FarMining9"].name;
                    storageID = storeTarget.id;
                } else if (farClaimers9.length < 1 && thisRoom.controller.level >= 4 && Memory.FarClaimerNeeded[Game.flags[thisRoom.name + "FarMining9"].pos.roomName] && blockedRole != 'farClaimer') {
                    prioritizedRole = 'farClaimer';
                    roomTarget = Game.flags[thisRoom.name + "FarMining9"].pos.roomName;
                    flagName = Game.flags[thisRoom.name + "FarMining9"].name;
                }
            ...
            if (Game.flags[thisRoom.name + "FarMineral"] && (!Memory.SKMineralTimers[Game.flags[thisRoom.name + "FarMineral"].pos.roomName] || Memory.SKMineralTimers[Game.flags[thisRoom.name + "FarMineral"].pos.roomName] == 0) && thisRoom.terminal && prioritizedRole == '') {
            ...
            if (Game.flags[thisRoom.name + "FarMineral2"] && (!Memory.SKMineralTimers[Game.flags[thisRoom.name + "FarMineral2"].pos.roomName] || Memory.SKMineralTimers[Game.flags[thisRoom.name + "FarMineral2"].pos.roomName] == 0) && thisRoom.terminal && prioritizedRole == '') {
            ...
            if (Game.flags[thisRoom.name + "FarMineral3"] && (!Memory.SKMineralTimers[Game.flags[thisRoom.name + "FarMineral3"].pos.roomName] || Memory.SKMineralTimers[Game.flags[thisRoom.name + "FarMineral3"].pos.roomName] == 0) && thisRoom.terminal && prioritizedRole == '') {
...
function getMinerBuild(energyCap, thisRoom) {
    //let thisConfig = [WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE];
    let thisConfig = [WORK, CARRY, MOVE];
